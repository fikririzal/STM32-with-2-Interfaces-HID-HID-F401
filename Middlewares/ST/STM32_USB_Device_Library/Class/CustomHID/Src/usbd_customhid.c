...
__ALIGN_BEGIN static uint8_t USBD_CUSTOM_HID_CfgDesc[USB_CUSTOM_HID_CONFIG_DESC_SIZ] __ALIGN_END =
{
  ...
  // TODO calculate USB_CUSTOM_HID_CONFIG_DESC_SIZ
  ...
  /************** Descriptor of CUSTOM HID (Keyboard) interface ****************/
  /* 09 */
  0x09,                                               /* bLength: Interface Descriptor size*/
  USB_DESC_TYPE_INTERFACE,                            /* bDescriptorType: Interface descriptor type */
  0x00,                                               /* bInterfaceNumber: Number of Interface */
  0x00,                                               /* bAlternateSetting: Alternate setting */
  // TODO if want to add more Endpoint, Change this
  0x01,                                               /* bNumEndpoints*/
  ...
  /******************** Descriptor of CUSTOM_HID (Keyboard) *************************/
  /* 18 */
  ...
  // TODO calculate USBD_CUSTOM_HID_REPORT_DESC_SIZE
  ...
  /******************** Descriptor of Custom HID endpoints (Keyboard)********************/
  /* 27 */
  0x07,                                               /* bLength: Endpoint Descriptor size */
  USB_DESC_TYPE_ENDPOINT,                             /* bDescriptorType: */
  CUSTOM_HID_KEYBOARD_EPIN_ADDR,                      /* bEndpointAddress: Endpoint Address (IN) (Keyboard) */
  0x03,                                               /* bmAttributes: Interrupt endpoint */
  LOBYTE(CUSTOM_HID_KEYBOARD_EPIN_SIZE),              /* wMaxPacketSize: 2 Bytes max */
  HIBYTE(CUSTOM_HID_KEYBOARD_EPIN_SIZE),
  CUSTOM_HID_FS_BINTERVAL,                            /* bInterval: Polling Interval */

  /************** Descriptor of CUSTOM HID (Joystick) interface ****************/
  /* 34 */
  0x09,                                               /* bLength: Interface Descriptor size*/
  USB_DESC_TYPE_INTERFACE,                            /* bDescriptorType: Interface descriptor type */
  ...
  /******************** Descriptor of CUSTOM_HID (Joystick) *************************/
  /* 43 */
  0x09,                                               /* bLength: CUSTOM_HID Descriptor size */
  CUSTOM_HID_DESCRIPTOR_TYPE,                         /* bDescriptorType: CUSTOM_HID */
  0x11,                                               /* bCUSTOM_HIDUSTOM_HID: CUSTOM_HID Class Spec release number */
  ...
  0x22,                                               /* bDescriptorType */
  // TODO calculate USBD_CUSTOM_HID_REPORT_DESC_SIZE
  LOBYTE(USBD_CUSTOM_HID_JOYSTICK_REPORT_DESC_SIZE),  /* wItemLength: Total length of Report descriptor */
  HIBYTE(USBD_CUSTOM_HID_JOYSTICK_REPORT_DESC_SIZE),

  /******************** Descriptor of Custom HID endpoints (Joystick) ********************/
  /* 52 */
  0x07,                                               /* bLength: Endpoint Descriptor size */
  USB_DESC_TYPE_ENDPOINT,                             /* bDescriptorType: */
  CUSTOM_HID_JOYSTICK_EPIN_ADDR,                      /* bEndpointAddress: Endpoint Address (IN) (Joystick) */
  0x03,                                               /* bmAttributes: Interrupt endpoint */
  LOBYTE(CUSTOM_HID_JOYSTICK_EPIN_SIZE),              /* wMaxPacketSize: 2 Bytes max */
  HIBYTE(CUSTOM_HID_JOYSTICK_EPIN_SIZE),
  CUSTOM_HID_FS_BINTERVAL,                            /* bInterval: Polling Interval */
  /* 59 */
};
#endif /* USE_USBD_COMPOSITE  */
...
__ALIGN_BEGIN static uint8_t USBD_KEYBOARD_HID_Desc[USB_CUSTOM_HID_DESC_SIZ] __ALIGN_END =
{
  /* 18 */
  0x09,                                               /* bLength: CUSTOM_HID Descriptor size */
  CUSTOM_HID_DESCRIPTOR_TYPE,                         /* bDescriptorType: CUSTOM_HID */
...
__ALIGN_BEGIN static uint8_t USBD_JOYSTICK_HID_Desc[USB_CUSTOM_HID_DESC_SIZ] __ALIGN_END =
{
  /* 18 */
  0x09,                                               /* bLength: CUSTOM_HID Descriptor size */
  CUSTOM_HID_DESCRIPTOR_TYPE,                         /* bDescriptorType: CUSTOM_HID */
...
__ALIGN_BEGIN static uint8_t KEYBOARD_HID_ReportDesc_FS[USBD_CUSTOM_HID_KEYBOARD_REPORT_DESC_SIZE] __ALIGN_END =
{
  /* USER CODE BEGIN 0 */
...
__ALIGN_BEGIN static uint8_t JOYSTICK_HID_ReportDesc_FS[USBD_CUSTOM_HID_JOYSTICK_REPORT_DESC_SIZE] __ALIGN_END =
{
  /* USER CODE BEGIN 0 */
  0x05, 0x01,                    // USAGE_PAGE (Generic Desktop)
      ...
      switch (req->bRequest)
      {
        ...
        case USB_REQ_GET_DESCRIPTOR:
          if ((req->wValue >> 8) == CUSTOM_HID_REPORT_DESC)
          {
            switch (req->wIndex) {
            case 0x0000:
            	pbuf = KEYBOARD_HID_ReportDesc_FS;
            	len = MIN(USBD_CUSTOM_HID_KEYBOARD_REPORT_DESC_SIZE, req->wLength);
            	break;
            case 0x0001:
            	pbuf = JOYSTICK_HID_ReportDesc_FS;
            	len = MIN(USBD_CUSTOM_HID_JOYSTICK_REPORT_DESC_SIZE, req->wLength);
            	break;
            default:
